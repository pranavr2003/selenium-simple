...
main_to_ex(r'sel-simple/|https://python.org|/#user-data-dir=C:\Users\SONY\AppData\Local\Google\Chrome\User Data/#profile-directory=Default/^assert "Python" in driver.title^/?febn=q/c/k-pycon?K-RETURN/}')

# If Windows:
# main_to_ex(r'sel-simple/|https://python.org|/#user-data-dir=C:\Users\SONY\AppData\Local\Google\Chrome\User Data/#profile-directory=Default/^assert "Python" in title^/?febn=q/c/k-pycon?K-RETURN/}')
